  ...
  return (
    <>
        ...
        <div className="section-content">
          ...
          <div className="sections-card">
            <div>
              ...
              <div className="instrument-img">
                <img src="https://www.iberoptics.com/c/408-categoria_general/camara-multiespectral-hiperespectral-vnir400-1000nm.jpg" alt="" />
            </div>
            </div>
            <div>
              ...
              <div className="instrument-img">
                <img src="https://www.researchgate.net/publication/344499765/figure/fig3/AS:943727254196231@1602013519366/Figura-10-Dron-multirotor-con-camara-multiespectral-acoplada.ppm" alt="" />
            </div>
            </div>
            <div>
              ...
              <div className="instrument-img">
                <img src="https://www.cartomex.com/wp-content/uploads/2015/11/worldview-2.jpg" alt="" />
            </div>
            </div>
            <div>
              ...
              <div className="instrument-img">
                <img src="https://mesurex.com/wp-content/uploads/2018/07/Productos-Inno-Spec-Visualize-Invisibility.png" alt="" />
            </div>
            </div>
            <div>
              ...
              <div className="instrument-img">
                <img src="https://actualidadaeroespacial.com/wp-content/uploads/2020/03/GA-AS-050320.jpg" alt="" />
            </div>
            </div>
            <div>
              ...
              <div className="instrument-img">
                <img src="https://grupoacre.es/wp-content/uploads/sites/3/2024/05/sentera-6x-sensor-dovetail-astro-1.jpg" alt="" />
            </div>
            </div>
            <div>
              ...
              <div className="instrument-img">
                <img src="https://www.iberoptics.com/5837-large_default/camara-multiespectral-vis-nir.jpg" alt="" />
            </div>
            </div>
          </div>
        </div>
      ...
      <div className="up-button">
        <a href="#Que-son"><img src={arrowSvg} alt="" srcset="" /></a>
      </div>
      <section>
